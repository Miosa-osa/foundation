...
<section class="ds-section">
	...
	<div class="ds-card">
		...
		<div class="ds-demo" style="gap: 24px; align-items: center;">
			...
			<div style="display: flex; flex-direction: column; align-items: center; gap: 6px;">
				...
				<span style="font-size: 11px; color: #999;">default</span>
			</div>
			<div style="display: flex; flex-direction: column; align-items: center; gap: 6px;">
	...
	<div class="ds-card">
		...
		<div class="ds-demo" style="gap: 20px; align-items: center;">
			<div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
				...
				<span style="font-size: 11px; color: #999;">unchecked</span>
			</div>
			<div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
				<Checkbox bind:checked={checkChecked} />
				<span style="font-size: 11px; color: #999;">checked</span>
			</div>
			<div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
				<Checkbox checked={false} indeterminate />
				<span style="font-size: 11px; color: #999;">indeterminate</span>
			</div>
			<div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
				<Checkbox bind:checked={checkDisabledOff} disabled />
				<span style="font-size: 11px; color: #999;">disabled off</span>
			</div>
			<div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
				<Checkbox bind:checked={checkDisabledOn} disabled />
				<span style="font-size: 11px; color: #999;">disabled on</span>
			</div>
		</div>
	</div>
	...
	<div class="ds-card">
		...
		<div style="display: flex; gap: 48px; flex-wrap: wrap;">
			<div>
				<p style="font-size: 12px; font-weight: 600; color: #999; margin: 0 0 12px; text-transform: uppercase; letter-spacing: 0.04em;">Plan</p>
				...
				<p style="font-size: 12px; color: #999; margin: 12px 0 0;">
					Selected: <code style="font-size: 11px; background: rgba(0,0,0,0.04); padding: 1px 5px; border-radius: 4px;">{radioVertical}</code>
				</p>
			</div>
		</div>
	</div>
	...
	<div class="ds-card">
		...
		<p style="font-size: 12px; color: #999; margin: 12px 0 0;">
			Selected: <code style="font-size: 11px; background: rgba(0,0,0,0.04); padding: 1px 5px; border-radius: 4px;">{radioHorizontal}</code>
		</p>
	</div>
...
<style>
	...
	:global(.dark) .fc-prefs-section__title {
		color: #e5e5e5;
	}
	...
	:global(.dark) .fc-prefs-row__label {
		color: #e5e5e5;
	}
