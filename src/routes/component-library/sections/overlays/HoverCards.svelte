...
<style>
	...
	.hvr-card {
		...
		pointer-events: auto;
		animation: hvrFadeIn 0.15s ease;
	}
	.hvr-card--below {
		top: calc(100% + 10px);
		left: 0;
	...
	.hvr-card--above { animation-name: hvrFadeInUp; }
	@keyframes hvrFadeInUp {
		from { opacity: 0; transform: translateY(-4px); }
		to   { opacity: 1; transform: translateY(0); }
	}
...
<section class="ds-section">
	...
	<div class="ds-card">
		...
		<div class="ds-demo ds-preview-dark" style="gap: 24px; flex-wrap: wrap; align-items: flex-start; min-height: 220px;">
			{#each profiles as profile}
				...
				>
					<span style="color: var(--dt); font-size: 14px; font-weight: 500; text-decoration: underline; text-underline-offset: 3px; text-decoration-color: var(--dbd); cursor: pointer; transition: text-decoration-color 0.15s;"
						role="button"
						tabindex="0"
					...
					{#if hovered === profile.id}
						<div class="hvr-card hvr-card--below" style="width: 300px; padding: 16px;">
							<!-- Avatar + name row -->
							...
							<div class="hvr-divider"></div>
							<!-- Stats -->
							<div style="display: flex; justify-content: space-around;">
								<div class="hvr-stat">
									<span class="hvr-stat__value">{profile.followers}</span>
									<span class="hvr-stat__label">Followers</span>
								</div>
								<div style="width: 1px; background: rgba(255,255,255,0.06);"></div>
								<div class="hvr-stat">
									<span class="hvr-stat__value">{profile.following}</span>
									<span class="hvr-stat__label">Following</span>
								</div>
								<div style="width: 1px; background: rgba(255,255,255,0.06);"></div>
								<div class="hvr-stat">
									<span class="hvr-stat__value">{profile.posts}</span>
									<span class="hvr-stat__label">Posts</span>
								</div>
							</div>
						</div>
					{/if}
	...
	<div class="ds-card">
		...
		<div class="ds-demo ds-preview-dark" style="gap: 28px; flex-wrap: wrap; align-items: flex-start; min-height: 200px;">
			{#each links as link}
				<div
					class="hvr-trigger"
					role="group"
				...
				>
					...
					{#if hovered === link.id}
						<div class="hvr-card hvr-card--below" style="width: 340px; padding: 16px;">
							<!-- Domain row -->
							...
							<div class="hvr-divider" style="margin: 10px 0;"></div>
	...
	<div class="ds-card">
		...
		<div class="ds-demo ds-preview-dark" style="gap: 20px; flex-wrap: wrap; align-items: flex-start; min-height: 260px;">
			{#each products as product}
				...
				>
					<span
						style="display: inline-flex; align-items: center; gap: 6px; color: var(--dt); font-size: 14px; font-weight: 500; cursor: default; padding: 6px 12px; border-radius: 8px; border: 1px solid var(--dbd); background: var(--dbg);"
						role="button"
						tabindex="0"
						aria-label="Preview {product.label}"
					>
						{product.label}
						<svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="color: var(--dt3);"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01" stroke-linecap="round"/></svg>
					</span>
					{#if hovered === product.id}
						<div class="hvr-card hvr-card--below" style="width: 280px; padding: 16px;">
							<!-- Badge + name -->
							<div style="display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 12px;">
	...
	<div class="ds-card">
		...
		<div class="ds-demo ds-preview-dark" style="align-items: flex-start; min-height: 200px;">
			<div
				class="hvr-trigger"
				role="group"
			...
			>
				...
				{#if hovered === 'task-preview'}
					<div class="hvr-card hvr-card--below" style="width: 320px; padding: 16px;">
						<!-- Task header -->
	...
	<div class="ds-card">
		...
		<div class="ds-demo ds-preview-dark" style="gap: 40px; flex-wrap: wrap; align-items: center; min-height: 180px; padding-top: 32px;">
			<!-- Above -->
			<div
				class="hvr-trigger"
				role="group"
			...
			>
				...
				{#if hovered === 'pos-above'}
					<div class="hvr-card hvr-card--above" style="width: 240px; padding: 14px;">
			...
			>
				...
				{#if hovered === 'pos-below'}
					<div class="hvr-card hvr-card--below" style="width: 240px; padding: 14px;">
			...
			>
				...
				{#if hovered === 'pos-right'}
					<div class="hvr-card hvr-card--right" style="width: 220px; padding: 14px;">
