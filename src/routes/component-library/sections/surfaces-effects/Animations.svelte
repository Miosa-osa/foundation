		...
		<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 20px;">
			...
			<div class="svelte-transition-demo">
				...
				<div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
					...
					<code style="font-size: 11px; color: var(--dt3);">fly(y: 20)</code>
				</div>
			</div>
			...
			<div class="svelte-transition-demo">
				...
				<div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
					...
					<code style="font-size: 11px; color: var(--dt3);">fade(200ms)</code>
				</div>
			</div>
			...
			<div class="svelte-transition-demo">
				...
				<div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
					...
					<code style="font-size: 11px; color: var(--dt3);">slide(250ms)</code>
				</div>
			</div>
			...
			<div class="svelte-transition-demo">
				...
				<div style="display: flex; align-items: center; gap: 8px; margin-top: 10px;">
					...
					<code style="font-size: 11px; color: var(--dt3);">scale(0.85)</code>
				</div>
			</div>
		</div>
	</div>
