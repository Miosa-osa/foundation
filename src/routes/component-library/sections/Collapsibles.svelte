...
<section class="ds-section">
	...
	<div class="ds-card">
		...
		<div class="ds-demo" style="display: block;">
			<div style="max-width: 560px; border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; overflow: hidden;">
				<button
					onclick={() => (basicOpen = !basicOpen)}
					aria-expanded={basicOpen}
					style="width: 100%; display: flex; justify-content: space-between; align-items: center; padding: 14px 16px; background: {basicOpen ? 'rgba(255,255,255,0.04)' : 'transparent'}; border: none; cursor: pointer; transition: background 0.15s; color: #fff;"
				>
					<div style="display: flex; align-items: center; gap: 10px;">
						<div style="width: 28px; height: 28px; border-radius: 7px; background: rgba(255,255,255,0.06); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
							<svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="color: #888;"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2z" stroke-linecap="round"/><path d="M12 8v4l3 3" stroke-linecap="round" stroke-linejoin="round"/></svg>
						</div>
						<div style="text-align: left;">
							<p style="font-size: 14px; font-weight: 500; color: #fff; margin: 0;">Release schedule</p>
							<p style="font-size: 12px; color: #555; margin: 2px 0 0;">Next release: Mar 14, 2026</p>
						</div>
					</div>
				...
				<div class="collapsible-body" class:is-open={basicOpen}>
					<div class="collapsible-inner">
						<div style="padding: 16px; border-top: 1px solid rgba(255,255,255,0.06); display: flex; flex-direction: column; gap: 10px;">
							{#each [
								...
								<div style="display: flex; gap: 14px; align-items: flex-start;">
									<span style="font-size: 12px; color: #555; min-width: 44px; padding-top: 1px; font-weight: 500;">{date}</span>
									<div style="width: 1px; background: rgba(255,255,255,0.07); align-self: stretch; margin-top: 4px; flex-shrink: 0;"></div>
									<span style="font-size: 13px; color: #999; line-height: 1.5;">{note}</span>
								</div>
							{/each}
						</div>
					</div>
	...
	<div class="ds-card">
		...
		<div class="ds-demo" style="display: block;">
			<div style="max-width: 560px; display: flex; flex-direction: column; gap: 12px;">
				<div style="display: flex; align-items: center; gap: 10px;">
					<p style="font-size: 14px; color: #ccc; margin: 0;">Advanced configuration</p>
					<button
						onclick={() => (customOpen = !customOpen)}
						aria-expanded={customOpen}
						style="display: inline-flex; align-items: center; gap: 5px; padding: 3px 10px; border-radius: 9999px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.04); color: #888; font-size: 12px; cursor: pointer; transition: all 0.15s; white-space: nowrap;"
					>
						{#if customOpen}
							...
							{#each [
								...
								<div style="display: flex; flex-direction: column; gap: 5px;">
									...
									<input
										...
										style="width: 100%; padding: 8px 12px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 8px; color: #ddd; font-size: 13px; outline: none; box-sizing: border-box;"
										aria-label={label}
									/>
								</div>
							{/each}
	...
	<div class="ds-card">
		...
		<div class="ds-demo" style="display: block;">
			<div style="max-width: 520px; border-radius: 12px; border: 1px solid {cardOpen ? 'rgba(255,255,255,0.12)' : 'rgba(255,255,255,0.07)'}; background: rgba(255,255,255,0.02); transition: border-color 0.2s;">
				...
				>
					<div style="display: flex; align-items: center; gap: 12px;">
						<div style="width: 36px; height: 36px; border-radius: 9px; background: rgba(255,255,255,0.06); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
							<svg width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" style="color: #aaa;"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9" stroke-linecap="round"/></svg>
						</div>
						<div style="text-align: left;">
							<p style="font-size: 14px; font-weight: 600; color: #fff; margin: 0; letter-spacing: -0.01em;">Usage summary</p>
							<p style="font-size: 12px; color: #555; margin: 3px 0 0;">Billing period: Feb 1 – Mar 1, 2026</p>
						</div>
					</div>
					<div style="display: flex; align-items: center; gap: 10px;">
						<span style="font-size: 15px; font-weight: 700; color: #fff; letter-spacing: -0.03em;">$24.80</span>
								...
								{#each [
									...
									<div style="display: flex; justify-content: space-between; align-items: center;">
										<div>
											...
											<span style="font-size: 12px; color: #555; margin-left: 8px;">{usage}</span>
										</div>
										<span style="font-size: 13px; color: #aaa; font-weight: 500;">{cost}</span>
									</div>
								{/each}
							</div>
							<div style="border-top: 1px solid rgba(255,255,255,0.06); padding: 12px 20px; display: flex; justify-content: space-between; align-items: center;">
								<span style="font-size: 13px; color: #888;">Total</span>
								<span style="font-size: 15px; font-weight: 700; color: #fff; letter-spacing: -0.02em;">$24.80</span>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="ds-demo" style="display: block;">
			<div style="max-width: 580px; display: flex; flex-direction: column; gap: 6px;">
				{#each changelogItems as item, i}
					...
					<div style="border: 1px solid {isOpen ? 'rgba(255,255,255,0.1)' : 'rgba(255,255,255,0.06)'}; border-radius: 10px; overflow: hidden; background: {isOpen ? 'rgba(255,255,255,0.02)' : 'rgba(255,255,255,0.01)'}; transition: border-color 0.15s, background 0.15s;">
						<button
						...
						>
							<span style="font-size: 13px; font-weight: 700; color: #fff; font-family: ui-monospace, monospace; letter-spacing: -0.02em;">{item.version}</span>
							<span style="flex: 1; font-size: 12px; color: #555; text-align: left;">{item.date}</span>
						...
						<div class="collapsible-body" class:is-open={isOpen}>
							<div class="collapsible-inner">
								<div style="border-top: 1px solid rgba(255,255,255,0.06); padding: 12px 16px; display: flex; flex-direction: column; gap: 7px;">
									{#each item.changes as change}
										<div style="display: flex; align-items: flex-start; gap: 8px;">
											<span style="color: #555; font-size: 14px; flex-shrink: 0; margin-top: -1px;">–</span>
											<span style="font-size: 13px; color: #999; line-height: 1.5;">{change}</span>
										</div>
									{/each}
								</div>
							</div>
	...
	<div class="ds-card">
		...
		<div class="ds-demo" style="display: block;">
			<div style="max-width: 400px; background: rgba(255,255,255,0.01); border: 1px solid rgba(255,255,255,0.07); border-radius: 10px; padding: 12px;">
				<!-- Root: src/ -->
				<div class="tree-node">
					<button
						onclick={() => treeToggle('src')}
						aria-expanded={treeState['src']}
						style="display: flex; align-items: center; gap: 7px; width: 100%; background: none; border: none; cursor: pointer; padding: 5px 6px; border-radius: 7px; color: #ddd; font-size: 13px; text-align: left; transition: background 0.12s;"
					>
						...
						<div class="collapsible-inner">
							<div class="tree-children">
								...
								{#each ['app.css', 'app.d.ts', 'app.html'] as file}
									<div style="display: flex; align-items: center; gap: 7px; padding: 5px 6px; border-radius: 7px; color: #777; font-size: 13px;">
										<span style="width: 13px;"></span>
										<svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" style="color: #555; flex-shrink: 0;"><path d="M13 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V9z" stroke-linecap="round" stroke-linejoin="round"/><polyline points="13 2 13 9 20 9" stroke-linecap="round" stroke-linejoin="round"/></svg>
										{file}
									</div>
								{/each}
											...
											<div class="tree-children">
												...
												<div class="tree-node">
													<button
														...
														style="display: flex; align-items: center; gap: 7px; width: 100%; background: none; border: none; cursor: pointer; padding: 5px 6px; border-radius: 7px; color: #ddd; font-size: 13px; text-align: left;"
													>
			...
			<div style="max-width: 560px;">
				<div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
					<div style="display: flex; align-items: center; gap: 8px;">
						<span style="font-size: 11px; font-weight: 600; color: #555; text-transform: uppercase; letter-spacing: 0.06em;">theme.ts</span>
						<span style="font-size: 10px; color: #444; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.06); border-radius: 4px; padding: 1px 5px;">TypeScript</span>
					</div>
					<button
						onclick={() => (codeOpen = !codeOpen)}
						aria-expanded={codeOpen}
						style="display: inline-flex; align-items: center; gap: 5px; font-size: 12px; color: #666; background: none; border: none; cursor: pointer; padding: 3px 6px; border-radius: 6px; transition: color 0.12s;"
					>
						{#if codeOpen}
				...
				<div class="code-block">
					...
					{#if !codeOpen}
						<div style="border-top: 1px solid rgba(255,255,255,0.06); padding: 8px 14px; display: flex; align-items: center; justify-content: center; background: linear-gradient(to bottom, rgba(10,10,10,0), rgba(10,10,10,0.8));">
							<button
								onclick={() => (codeOpen = true)}
								aria-label="Show full code snippet"
								style="font-size: 12px; color: #888; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.08); border-radius: 6px; padding: 5px 12px; cursor: pointer; transition: color 0.12s, background 0.12s; display: flex; align-items: center; gap: 6px;"
							>
								<svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 5v14M5 12h14" stroke-linecap="round"/></svg>
